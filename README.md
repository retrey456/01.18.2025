Book.php — класс для работы с книгами. Reader.php — класс для работы с читателями. Library.php — класс для работы с библиотекой. index.php — основной файл, который использует все классы и выводит результат.
